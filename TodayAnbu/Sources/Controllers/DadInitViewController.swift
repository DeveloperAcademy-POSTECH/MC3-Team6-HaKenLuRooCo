...
class DadInitViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBOutlet weak var dadDayVstack: UIStackView!
    @IBOutlet weak var dadNumberTextfield: UITextField!
...
extension DadInitViewController {
    ...
    private func setHStackViewDefaultConstraints() {
        dadDayVstack.addSubview(notificationTimeSettingText)
        notificationTimeSettingText.translatesAutoresizingMaskIntoConstraints = false
        NSLayoutConstraint.activate([
            notificationTimeSettingText.topAnchor.constraint(equalTo: dadDayVstack.topAnchor, constant: 10),
            notificationTimeSettingText.leftAnchor.constraint(equalTo: dadDayVstack.leftAnchor, constant: 5)
        ])

        dadDayVstack.addSubview(notificationGuideText)
        ...
        NSLayoutConstraint.activate([
            ...
            notificationGuideText.leftAnchor.constraint(equalTo: dadDayVstack.leftAnchor, constant: 5)
        ])

        dadDayVstack.addSubview(horizontalStack)
        ...
        NSLayoutConstraint.activate([
            ...
            horizontalStack.centerXAnchor.constraint(equalTo: dadDayVstack.centerXAnchor)
        ])
    }
